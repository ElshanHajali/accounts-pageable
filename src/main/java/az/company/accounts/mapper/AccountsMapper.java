...
public interface AccountsMapper {
    ...
    default PageableAccountsResponse entityToPageableResponse(
            List<AccountsResponse> accounts,
            Page<AccountsEntity> pageableAccounts
    ) {
        return PageableAccountsResponse.builder()
                .accounts(accounts)
                .hasNextPage(pageableAccounts.hasNext())
                .totalElements(pageableAccounts.getTotalElements())
                .totalPages(pageableAccounts.getTotalPages())
                .build();
    }

    default void updateDesiredEntityField(AccountsEntity account,
